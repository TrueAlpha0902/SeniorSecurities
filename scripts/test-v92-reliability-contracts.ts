...
assert(
  ...
  "The home hero must use native text with text-free vector art instead of repeating the title.",
);
assert(
  materials.includes("V93AnswerBadge")
    && materials.includes("V93StateIllustration"),
  "The coordinated native material system must cover quiz and state feedback.",
);
...
console.log(
  "v91.2.2 reliability contracts passed: native UI materials, question API, retries, migration, and post-deploy smoke checks.",
);
