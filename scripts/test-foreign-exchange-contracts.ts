...
assert(practice.includes("currentQuestion.explanation") && practice.includes("answer-result-label") && !practice.includes("foreignExchangeAnswerText(currentQuestion)"), "Revealed results must show explanation and option-led official answer feedback without a duplicate answer line.");
